...
- **되돌리기 / 재실행** (`Ctrl+Z`, `Ctrl+Y`): 페이지 삽입·삭제·회전·붙여넣기 등
...
고급 설정에서 **회색조 / 단색조** 변환, **페이지 크기만 / 내용 크기만** 조정도 선택할 수 있습니다.

**사용 순서**

1. **[1단계] 예상 최종 크기 산정**  
   압축 옵션을 조정한 뒤 **[예상 최종 크기 산정]**을 누르면 예상 파일 크기가 계산됩니다.

2. **[2단계] (선택) 희망 최종 용량 설정 및 용량 줄이기 자동 반복**  
   원하는 목표 용량(4.5~10 MB)을 정한 뒤 **[용량 줄이기 반복 실행]**을 누르면, 목표 용량 미만이 될 때까지 설정을 자동 조정·재산정합니다.  
   2단계 없이 1단계 결과만 적용해도 됩니다.

3. **[3단계] 최종 적용 하기**  
   **[최종 적용 하기]**로 산정된 결과를 현재 문서에 반영합니다. 적용 후 **저장** 또는 **다른 이름으로 저장**으로 파일을 저장하세요.

...
2. 압축을 푼 뒤, 폴더 안의 `Tiny PDF Editor v1.0.3_YYMMDD_HHMMSS.exe`를 실행합니다.
...
```
dist/
  Tiny PDF Editor v1.0.3_YYMMDD_HHMMSS/
    Tiny PDF Editor v1.0.3_YYMMDD_HHMMSS.exe

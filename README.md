...
2. 압축을 푼 뒤, 폴더 안의 `Tiny PDF Editor v1.1.4_YYMMDD_HHMMSS.exe`를 실행합니다.
...
1. `Tiny PDF Editor v1.1.4_YYMMDD_HHMMSS.msi`를 더블 클릭해 설치합니다.
...
```
dist/
  Tiny PDF Editor v1.1.4_YYMMDD_HHMMSS/
    Tiny PDF Editor v1.1.4_YYMMDD_HHMMSS.exe
...
```
msi/
  Tiny PDF Editor v1.1.4_YYMMDD_HHMMSS.msi
```
